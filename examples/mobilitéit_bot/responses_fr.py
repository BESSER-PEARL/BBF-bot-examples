...
greeting_text = "Salut ! Je suis le Bot Mobiliteit, et je suis là pour t'aider à te déplacer au Luxembourg en utilisant les transports publics ! Pour commencer, peux-tu me dire d'où tu veux partir ? (Le nom de l'arrêt de bus ou le nom de l'endroit 🚌 !)"

fallback_s0_text = "Je n'ai pas compris ça 😅. Peut-être essaie de demander de l'aide si tu veux des conseils utiles !"

s1_text = "Peux-tu me dire d'où tu veux partir ? (Le nom de l'arrêt de bus ou le nom de l'endroit 🚌 !)"
...
stop_list_text = "Lesquels parmi les arrêts de bus/train suivants correspondent au tien ? \n"
